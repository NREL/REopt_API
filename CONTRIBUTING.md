...
#### Reporting Bugs
Please create an [issue](https://github.com/NREL/REopt_API/issues) for a bug that you have encountered. (The issue template provides more guidance.)
...
- If it passes, send a PR to the original repository. If you haven't signed the [Code License Agreement](https://github.com/NREL/REopt_API/blob/master/cla.md) already, the CLA Assistant will comment on your PR and request you to sign the CLA. You can simply comment "I have read the CLA Document and I hereby sign the CLA" to sign the [CLA](https://github.com/NREL/REopt_API/blob/master/cla.md). 
