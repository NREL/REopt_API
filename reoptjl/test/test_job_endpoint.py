...
class TestJobEndpoint(ResourceTestCaseMixin, TransactionTestCase):
    ...
    def test_multiple_outages(self):
        ...
        self.assertAlmostEqual(results["Outages"]["microgrid_upgrade_capital_cost"], 1974429.4, places=-2)
        self.assertAlmostEqual(results["Financial"]["lcc"], 59868435.9, places=-3)
