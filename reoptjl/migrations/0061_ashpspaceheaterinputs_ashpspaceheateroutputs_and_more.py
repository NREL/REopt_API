# Generated by Django 4.0.7 on 2024-08-30 20:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_allowable_peak_load_fraction', models.FloatField(blank=True, default=0.0, help_text='Minimum nonzero thermal power as a fucniton of coincident peak load - constraint for optimization [ton]', null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100000000.0)])),
                ...
                ('avoided_capex_by_ashp_present_value', models.FloatField(blank=True, default=100000000.0, help_text='Maximum thermal power size constraint for optimization [ton]', null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100000000.0)])),
                ('back_up_temp_threshold_degF', models.FloatField(blank=True, default=100000000.0, help_text='Maximum thermal power size constraint for optimization [ton]', null=True, validators=[django.core.validators.MinValueValidator(-275.0), django.core.validators.MaxValueValidator(200.0)])),
            ],
