...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('reoptjl', '0005_remove_electrictariffinputs_coincident_peak_load_active_timesteps_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            name='SiteOutputs',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='SiteOutputs', serialize=False, to='reoptjl.apimeta')),
