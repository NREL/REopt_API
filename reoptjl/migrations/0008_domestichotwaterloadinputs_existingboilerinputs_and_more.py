# Generated by Django 4.0.6 on 2022-09-02 01:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('reoptjl', '0007_windinputs_operating_reserve_required_pct_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='DomesticHotWaterLoadInputs',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='DomesticHotWaterLoadInputs', serialize=False, to='reoptjl.apimeta')),
                ('annual_mmbtu', models.FloatField(blank=True, help_text="Annual site DHW consumption, used to scale simulated default building load profile for the site's climate zone [MMBtu]", null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(100000000.0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ExistingBoilerInputs', serialize=False, to='reoptjl.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ExistingBoilerOutputs', serialize=False, to='reoptjl.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='SpaceHeatingLoadInputs', serialize=False, to='reoptjl.apimeta')),
