# Generated by Django 3.1.13 on 2021-10-18 18:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reopt_version', models.TextField(blank=True, default='', help_text='Version number of the Julia package for REopt that is used to solve the problem.')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ElectricLoadInputs', serialize=False, to='reoptjl.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ElectricLoadOutputs', serialize=False, to='reoptjl.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ElectricTariffInputs', serialize=False, to='reoptjl.apimeta')),
                ...
                ('urdb_response', models.JSONField(blank=True, help_text='Utility rate structure from Utility Rate Database API https://openei.org/services/doc/rest/util_rates/?version=8', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ElectricTariffOutputs', serialize=False, to='reoptjl.apimeta')),
                ...
                ('lifecycle_energy_cost', models.FloatField(blank=True, help_text='Optimal life cycle utility energy cost, after-tax', null=True)),
                ('lifecycle_demand_cost', models.FloatField(blank=True, help_text='Optimal life cycle utility demand cost, after-tax', null=True)),
                ('lifecycle_fixed_cost', models.FloatField(blank=True, help_text='Optimal life cycle utility fixed cost, after-tax', null=True)),
                ('lifecycle_min_charge_adder', models.FloatField(blank=True, help_text='Optimal life cycle utility minimum charge adder, after-tax', null=True)),
                ('lifecycle_energy_cost_bau', models.FloatField(blank=True, help_text='Business as usual life cycle utility energy cost, after-tax', null=True)),
                ('lifecycle_demand_cost_bau', models.FloatField(blank=True, help_text='Business as usual life cycle lifecycle utility demand cost, after-tax', null=True)),
                ('lifecycle_fixed_cost_bau', models.FloatField(blank=True, help_text='Business as usual life cycle utility fixed cost, after-tax', null=True)),
                ('lifecycle_min_charge_adder_bau', models.FloatField(blank=True, help_text='Business as usual life cycle utility minimum charge adder, after-tax', null=True)),
                ('lifecycle_export_benefit', models.FloatField(blank=True, help_text='Optimal life cycle value of exported energy, after-tax', null=True)),
                ('lifecycle_export_benefit_bau', models.FloatField(blank=True, help_text='Business as usual life cycle value of exported energy, after-tax', null=True)),
                ('year_one_bill', models.FloatField(blank=True, help_text='Optimal year one utility bill', null=True)),
                ('year_one_bill_bau', models.FloatField(blank=True, help_text='Business as usual year one utility bill', null=True)),
                ...
                ('lifecycle_coincident_peak_cost', models.FloatField(blank=True, help_text='Optimal total coincident peak charges over the analysis period, after-tax', null=True)),
                ('lifecycle_coincident_peak_cost_bau', models.FloatField(blank=True, help_text='Business as usual life cycle coincident peak charges, after-tax', null=True)),
                ...
                ('lifecycle_chp_standby_cost', models.FloatField(blank=True, help_text='Optimal life cycle standby charge cost incurred by CHP, after-tax', null=True)),
            ],
            bases=(reoptjl.models.BaseModel, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ElectricUtilityInputs', serialize=False, to='reoptjl.apimeta')),
                ('outage_start_time_step', models.IntegerField(blank=True, help_text='Time step that grid outage starts. Must be less than outage_end.', null=True, validators=[django.core.validators.MinValueValidator(1)])),
                ('outage_end_time_step', models.IntegerField(blank=True, help_text='Time step that grid outage ends. Must be greater than outage_start.', null=True, validators=[django.core.validators.MinValueValidator(1)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ElectricUtilityOutputs', serialize=False, to='reoptjl.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='FinancialInputs', serialize=False, to='reoptjl.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='FinancialOutputs', serialize=False, to='reoptjl.apimeta')),
                ...
                ('lifecycle_capital_costs_plus_om', models.FloatField(blank=True, help_text='Capital cost for all technologies plus present value of operations and maintenance over anlaysis period', null=True)),
                ('lifecycle_om_costs_bau', models.FloatField(blank=True, help_text='Business-as-usual present value of operations and maintenance over analysis period', null=True)),
                ('lifecycle_capital_costs', models.FloatField(blank=True, help_text='Net capital costs for all technologies, in present value, including replacement costs and incentives.', null=True)),
                ...
                ('lifecycle_om_costs_after_tax', models.FloatField(blank=True, help_text='Life cycle operations and maintenance cost over analysis period after tax.', null=True)),
                ...
                ('lifecycle_om_costs_before_tax', models.FloatField(blank=True, help_text='Life cycle operations and maintenance cost over analysis period before tax.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='GeneratorInputs', serialize=False, to='reoptjl.apimeta')),
                ...
                ('fuel_intercept_gal_per_hr', models.FloatField(blank=True, help_text='Generator fuel consumption curve y-intercept in gallons per hour.', null=True, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(10.0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='GeneratorOutputs', serialize=False, to='reoptjl.apimeta')),
                ...
                ('lifecycle_variable_om_cost', models.FloatField(blank=True, null=True)),
                ('lifecycle_variable_om_cost_bau', models.FloatField(blank=True, null=True)),
                ('lifecycle_fuel_cost', models.FloatField(blank=True, null=True)),
                ('lifecycle_fuel_cost_bau', models.FloatField(blank=True, null=True)),
                ('lifecycle_fixed_om_cost', models.FloatField(blank=True, null=True)),
                ('lifecycle_fixed_om_cost_bau', models.FloatField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            name='Settings',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='Settings', serialize=False, to='reoptjl.apimeta')),
        ...
        migrations.CreateModel(
            name='SiteInputs',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='SiteInputs', serialize=False, to='reoptjl.apimeta')),
        ...
        migrations.CreateModel(
            name='StorageInputs',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='StorageInputs', serialize=False, to='reoptjl.apimeta')),
        ...
        migrations.CreateModel(
            name='StorageOutputs',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='StorageOutputs', serialize=False, to='reoptjl.apimeta')),
                ('size_kw', models.FloatField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            name='UserProvidedMeta',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='UserProvidedMeta', serialize=False, to='reoptjl.apimeta')),
                ('description', models.TextField(blank=True, help_text='Optional user defined description.')),
                ('address', models.TextField(blank=True, help_text='Optional user defined address (street address, city, state or zip code)')),
            ],
            bases=(reoptjl.models.BaseModel, models.Model),
        ),
        migrations.CreateModel(
            name='WindInputs',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='WindInputs', serialize=False, to='reoptjl.apimeta')),
        ...
        migrations.CreateModel(
            name='WindOutputs',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='WindOutputs', serialize=False, to='reoptjl.apimeta')),
                ('size_kw', models.FloatField(blank=True, null=True)),
                ('lifecycle_om_cost', models.FloatField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size_kw', models.FloatField(blank=True, null=True)),
                ('lifecycle_om_cost', models.FloatField(blank=True, null=True)),
                ('lifecycle_om_cost_bau', models.FloatField(blank=True, null=True)),
                ('average_annual_energy_produced_kwh', models.FloatField(blank=True, null=True)),
                ...
                ('year_one_curtailed_production_series_kw', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(blank=True, null=True), blank=True, default=list, size=None)),
                ('lcoe_per_kwh', models.FloatField(blank=True, null=True)),
                ('meta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PVOutputs', to='reoptjl.apimeta')),
            ],
            bases=(reoptjl.models.BaseModel, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('can_export_beyond_nem_limit', models.BooleanField(blank=True, default=True, help_text='True/False for if technology can export energy beyond the annual site load (and be compensated for that energy at the export_rate_beyond_net_metering_limit).')),
                ('can_curtail', models.BooleanField(blank=True, default=True, help_text='True/False for if technology has the ability to curtail energy production.')),
                ('meta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PVInputs', to='reoptjl.apimeta')),
            ],
            bases=(reoptjl.models.BaseModel, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Message', to='reoptjl.apimeta')),
            ],
            bases=(reoptjl.models.BaseModel, models.Model),
        ),
    ]
