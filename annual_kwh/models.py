# no need for django model - we do not need to save any of this information
...
class AnnualkWhModel:
    """
    Set up to allow auto-filling of annual load in REopt webtool user input page.
    Requires building type and latitude/longitude to determine the commercial building load profile.
    Returns the annual load for the same building type in the same climate zone as the user's latitude/longitude.
    """
    
    def __init__(self, bldg, latitude, longitude, *args, **kwargs):

        city = self._nearest_city(latitude, longitude)
        self.annual_kwh = annual_loads[city][bldg]
