# Generated by Django 4.0.7 on 2023-01-31 04:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thermal_consumption_hot_water_or_steam', models.TextField(blank=True, choices=[('steam', 'Steam'), ('hot_water', 'Hot Water')], help_text='Boiler thermal production type, hot water or steam')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_one_to_tes_series_ton', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(blank=True), blank=True, default=list, help_text='Year one hourly time series of absorption chiller thermal to cold TES [Ton]', null=True, size=None)),
                ('year_one_to_load_series_ton', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(blank=True), blank=True, default=list, help_text='Year one hourly time series of absorption chiller thermal to cooling load [Ton]', null=True, size=None)),
                ('year_one_thermal_consumption_series_mmbtu_per_hr', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(blank=True), blank=True, default=list, help_text='Year one hourly time series of absorption chiller electric consumption [kW]', null=True, size=None)),
                ('year_one_thermal_consumption_mmbtu', models.FloatField(blank=True, help_text='Year one absorption chiller electric consumption [kWh]', null=True)),
                ('year_one_thermal_production_tonhour', models.FloatField(blank=True, help_text='Year one absorption chiller thermal production [Ton Hour', null=True)),
                ('year_one_electric_consumption_series_kw', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(blank=True), blank=True, default=list, help_text='Year one hourly time series of absorption chiller electric consumption [kW]', null=True, size=None)),
                ('year_one_electric_consumption_kwh', models.FloatField(blank=True, help_text='Year one absorption chiller electric consumption [kWh]', null=True)),
            ],
            bases=(job.models.BaseModel, models.Model),
        ),
    ]
