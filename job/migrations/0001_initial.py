# Generated by Django 3.1.12 on 2021-09-01 19:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dc_ac_ratio', models.FloatField(blank=True, default=0.023, help_text='PV DC-AC ratio', validators=[django.core.validators.MinValueValidator(-1), django.core.validators.MaxValueValidator(1)])),
                ...
                ('scenario', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PVInputs', to='job.scenario')),
            ],
            bases=(job.models.BaseModel, models.Model),
        ),
        migrations.CreateModel(
