...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ElectricLoadInputs', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ElectricLoadOutputs', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ElectricTariffInputs', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ElectricTariffOutputs', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ElectricUtilityInputs', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ElectricUtilityOutputs', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='FinancialInputs', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='FinancialOutputs', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='GeneratorInputs', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='GeneratorOutputs', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            name='Settings',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='Settings', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            name='SiteInputs',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='SiteInputs', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            name='StorageInputs',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='StorageInputs', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            name='StorageOutputs',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='StorageOutputs', serialize=False, to='job.apimeta')),
                ('size_kw', models.FloatField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='UserProvidedMeta', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            name='WindInputs',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='WindInputs', serialize=False, to='job.apimeta')),
        ...
        migrations.CreateModel(
            name='WindOutputs',
            fields=[
                ('meta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='WindOutputs', serialize=False, to='job.apimeta')),
                ('size_kw', models.FloatField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_one_curtailed_production_series_kw', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(blank=True, null=True), blank=True, default=list, size=None)),
                ('lcoe_per_kwh', models.FloatField(blank=True, null=True)),
                ('meta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PVOutputs', to='job.apimeta')),
            ],
            bases=(job.models.BaseModel, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('can_export_beyond_nem_limit', models.BooleanField(blank=True, default=True, help_text='True/False for if technology can export energy beyond the annual site load (and be compensated for that energy at the export_rate_beyond_net_metering_limit).')),
                ('can_curtail', models.BooleanField(blank=True, default=True, help_text='True/False for if technology has the ability to curtail energy production.')),
                ('meta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PVInputs', to='job.apimeta')),
            ],
            bases=(job.models.BaseModel, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Message', to='job.apimeta')),
            ],
            bases=(job.models.BaseModel, models.Model),
        ),
    ]
