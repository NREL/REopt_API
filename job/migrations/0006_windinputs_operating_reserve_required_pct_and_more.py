...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.FloatField(blank=True, help_text='Only applicable when off_grid_flag = True. Set to 0.10 for off-grid scenarios, 0.0 for on-grid runs.Required operating reserves applied to each timestep as a fraction of wind generation serving load in that timestep.', null=True, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)]),
        ),
        ...
        migrations.AlterField(
            ...
            name='fuel_avail_gal',
            field=models.FloatField(blank=True, help_text='On-site generator fuel available in gallons.', null=True, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1000000000.0)]),
        ),
        migrations.AlterField(
            model_name='generatorinputs',
        ...
        migrations.AlterField(
            model_name='pvinputs',
            name='operating_reserve_required_pct',
            field=models.FloatField(blank=True, help_text='When off_grid_flag = True, this field is automatically set to 0.25, but can be adjusted. For on-grid runs, this field is set to 0 pct.Required operating reserves applied to each timestep as a fraction of PV generation serving load in that timestep.', null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1.0)]),
        ),
        migrations.AlterField(
            model_name='pvinputs',
            name='tilt',
