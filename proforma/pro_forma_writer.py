...
class ProFormaWriter(object):
    ...
    def __init__(self, uuid, **kwargs):
        ...
        # system sizes
        self.pv_kw = kwargs['pv_kw']
        self.batt_kw = kwargs['batt_kw']
        self.batt_kwh = kwargs['batt_kwh']
        ...
        # input to template
        self.pv_installed_cost = self.pv_kw * self.econ.pv_cost
        self.battery_installed_cost = self.batt_kw * self.econ.batt_cost_kw + self.batt_kwh * self.econ.batt_cost_kwh
        self.total_capital_costs = self.pv_installed_cost + self.battery_installed_cost

        self.year_one_bill = kwargs['year_one_demand_cost'] + kwargs['year_one_energy_cost']
        self.year_one_exports = kwargs['year_one_export_benefit']
        self.year_one_bill_bau = kwargs['year_one_demand_cost_bau'] + kwargs['year_one_energy_cost_bau']
        self.year_one_energy_produced = kwargs['year_one_energy_produced']
