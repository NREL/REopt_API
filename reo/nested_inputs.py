...
nested_inputs = {
            ...
            "Financial":{   "om_cost_growth_pct":{ 'type': float, 'min': -1, 'max': 1 },
                            ...
                            "offtaker_discount_pct":{ 'type': float,'min': -1, 'max': 1  },
            ...
            "ElectricTariff": {
                                ...
                                "wholesale_rate_us_dollars_per_kwh":{ 'type': float, 'min': 0 },
            ...
            "Wind":{
                                ...
                                "installed_cost_us_dollars_per_kw":{ 'type': float, 'min': 0, 'max': 1e5 },
                                "om_cost_us_dollars_per_kw":{ 'type': float, 'min': 0, 'max': 1e3 },
                                ...
                                "state_ibi_max_us_dollars": { 'type': float,'min': 0, 'max': 1e9},
                                "utility_ibi_pct": { 'type': float,'min': 0, 'max': 1 },
                                "utility_ibi_max_us_dollars": { 'type': float,'min': 0, 'max': 1e9},
                                "federal_rebate_us_dollars_per_kw": { 'type': float,'min': 0, 'max': 1e9 },
                                "state_rebate_us_dollars_per_kw": { 'type': float,'min': 0, 'max': 1e9},
                                "state_rebate_max_us_dollars": { 'type': float,'min': 0, 'max': 1e9},
                                "utility_rebate_us_dollars_per_kw": { 'type': float,'min': 0, 'max': 1e9 },
                                "utility_rebate_max_us_dollars": { 'type': float,'min': 0, 'max': 1e9 },
                                "pbi_us_dollars_per_kwh": { 'type': float,'min': 0, 'max': 1e9 },
                                "pbi_max_us_dollars": { 'type': float,'min': 0, 'max': 1e9 },
                                "pbi_years": { 'type': float,'min': 0, 'max': 1e9 },
                                "pbi_system_max_kw": { 'type': float,'min': 0, 'max': 1e9},
                                },
            ...
            "Storage":{         "min_kw": { 'type': float,'min': 0, 'max': 1e9 },
                                ...
                                "installed_cost_us_dollars_per_kw": { 'type': float,'min': 0, 'max': 1e4 },
                                "installed_cost_us_dollars_per_kwh": { 'type': float,'min': 0, 'max': 1e4 },
                                "replace_cost_us_dollars_per_kw": { 'type': float, 'min': 0, 'max': 1e4 },
                                ...
                                "total_rebate_us_dollars_per_kw": { 'type': float,'min': 0, 'max': 1e9 },
