...
nested_input_definitions = {
    ...
    "Scenario": {
                ...
                "Site": {
                            ...
                            "ElectricTariff": {
                                                "urdb_utilty_name":                         {'type': 'str', 'replacement_sets':[['urdb_response'], ['monthly_demand_charges_us_dollars_per_kw', 'blended_monthly_rates_us_dollars_per_kwh'], ["urdb_label"], ["urdb_utilty_name", "urdb_rate_name"]],
                                                ...
                                                "urdb_rate_name":                           {'type': 'str', 'replacement_sets':[['urdb_response'], ['monthly_demand_charges_us_dollars_per_kw', 'blended_monthly_rates_us_dollars_per_kwh'], ["urdb_label"], ["urdb_utilty_name", "urdb_rate_name"]],
                                                ...
                                                "blended_monthly_rates_us_dollars_per_kwh": {'type': 'list_of_float', 'replacement_sets':[['urdb_response'], ['monthly_demand_charges_us_dollars_per_kw', 'blended_monthly_rates_us_dollars_per_kwh'], ["urdb_label"], ["urdb_utilty_name", "urdb_rate_name"]], 
                                                                                             'depends_on': ['monthly_demand_charges_us_dollars_per_kw'],
                                                                                             "description": "12 item array of average monthly utility rates per kWh" },
                                                "monthly_demand_charges_us_dollars_per_kw": {'type': 'list_of_float', 'replacement_sets':[['urdb_response'], ['monthly_demand_charges_us_dollars_per_kw', 'blended_monthly_rates_us_dollars_per_kwh'], ["urdb_label"], ["urdb_utilty_name", "urdb_rate_name"]],
                                                ...
                                                "urdb_response":                            {'type': 'dict', 'replacement_sets':[['urdb_response'], ['monthly_demand_charges_us_dollars_per_kw', 'blended_monthly_rates_us_dollars_per_kwh'], ["urdb_label"], ["urdb_utilty_name", "urdb_rate_name"]],
                                                ...
                                                "urdb_label":                               {'type': 'str', 'replacement_sets':[['urdb_response'], ['monthly_demand_charges_us_dollars_per_kw', 'blended_monthly_rates_us_dollars_per_kwh'], ["urdb_label"], ["urdb_utilty_name", "urdb_rate_name"]],
                            ...
                            "Wind":{
                                                ...
                                                "pbi_years":                            {'type': 'float', 'min': 0, 'max': 1e9, 'default': 1,
