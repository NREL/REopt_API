...
nested_inputs = {
            ...
            "Wind":{
                                ...
                                "state_ibi_max_us_dollars": { 'type': float,'min': 0, 'max': 1 },
                                "utility_ibi_pct": { 'type': float,'min': 0, 'max': 1 },
                                "utility_ibi_max_us_dollars": { 'type': float,'min': 0, 'max': 1 },
                                "federal_rebate_us_dollars_per_kw": { 'type': float,'min': 0, 'max': 1 },
                                "state_rebate_us_dollars_per_kw": { 'type': float,'min': 0, 'max': 1 },
                                "state_rebate_max_us_dollars": { 'type': float,'min': 0, 'max': 1 },
                                "utility_rebate_us_dollars_per_kw": { 'type': float,'min': 0, 'max': 1 },
                                "utility_rebate_max_us_dollars": { 'type': float,'min': 0, 'max': 1 },
            ...
            "Storage":{         "min_kw": { 'type': float,'min': 0, 'max': 1e9 },
                                ...
                                "total_rebate_us_dollars_per_kw": { 'type': float,'min': 0, 'max': 1 },
