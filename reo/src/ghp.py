...
ground_k_filepath = os.path.join('input_files', 'ground_conductivity.csv')
ground_k_by_climate_zone = pd.read_csv(ground_k_filepath, index_col="zone", dtype={"zone":str, "k": float})
