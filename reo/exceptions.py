...
class REoptError(Exception):
    ...
    def __init__(self, task='', name='', run_uuid='', message='', traceback='', user_uuid=''):
        ...
        if message == "Wind Dataset Timed Out":
            ...
            msg_with_email = ". Please increase your PV search radius parameter, or choose an alternate location with similar solar irradiance and weather trends. You can also use a search radius of 0 to return PV Watts results regardless of distance to the nearest station."
        elif run_uuid:
