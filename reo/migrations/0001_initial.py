    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('description', models.TextField(default=b'', blank=True)),
                ('messages_group_type_model', models.ForeignKey(default=None, to='reo.MessagesGroupTypeModel')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scenario_model', models.ForeignKey(default=None, to='reo.ScenarioModel')),
            ],
        ),
        migrations.CreateModel(
            name='StorageModel',
            fields=[
                ...
                ('site_model', models.ForeignKey(default=None, to='reo.SiteModel')),
            ],
        ),
        migrations.CreateModel(
            name='URDBError',
        ...
        migrations.AddField(
            model_name='pvmodel',
            name='site_model',
            field=models.ForeignKey(default=None, to='reo.SiteModel'),
        ),
        migrations.AddField(
            model_name='messagesmodel',
            name='messages_type_model',
            field=models.ForeignKey(default=None, to='reo.MessagesTypeModel'),
        ),
        migrations.AddField(
            model_name='messagesmodel',
            name='scenario_model',
            field=models.ForeignKey(default=None, to_field=b'run_uuid', blank=True, to='reo.ScenarioModel', null=True),
        ),
        migrations.AddField(
