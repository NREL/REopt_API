...
class TestPVWindProdFactor(ResourceTestCaseMixin, TestCase):
    ...
    def setUp(self):
        ...
        "Site": {
          ...
          "LoadProfile": {"doe_reference_name": "MidriseApartment", "annual_kwh": None, "critical_loads_kw_is_net": False, "year": 2017, "loads_kw_is_net": True, "outage_start_hour": None, "outage_end_hour": None, "monthly_totals_kwh": [], "critical_load_pct": 0.5, "outage_is_major_event": True, "critical_loads_kw": []},
          "address": "", 
