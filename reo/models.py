...
class RunOutput(models.Model):
    ...
    year_one_fixed_cost = models.FloatField(null=True, blank=True, default=0)
    ...
    year_one_fixed_cost_bau = models.FloatField(null=True, blank=True, default=0)
    ...
    total_fixed_cost = models.FloatField(null=True, blank=True, default=0)
    total_energy_cost_bau = models.FloatField(null=True, blank=True)
    total_demand_cost_bau = models.FloatField(null=True, blank=True)
    total_fixed_cost_bau = models.FloatField(null=True, blank=True, default=0)
